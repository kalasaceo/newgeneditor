...
class AddTextOnVideoActivity : BaseActivity(R.layout.activity_add_text_on_video, R.string.add_text_on_video) {
    ...
    override fun initialization() {
        ...
        thiscolor = intent.getStringExtra("LocalTextColor")
        if (thisdata != null) {
    ...
    private fun addTextProcess() {
        ...
        val query=addTextOnVideoFun(tvInputPathVideostr.toString(),edtTextstr.toString(), xPos, yPos, fontPath = fontPath, isTextBackgroundDisplay = false, fontSize = 79, fontcolor = thiscolor, output = outputPath);
